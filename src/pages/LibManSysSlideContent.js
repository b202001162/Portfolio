...
export default function LibManSysSlideContent() {
  return (
    <>
          ...
          <div className="LibraryManagementSlideContent">
            <div className="LibraryManagementSlideContentTitle">
              ...
              <div className="LibraryManagementSlideContentTitleSub">
                User-friendly C based Library Management System with advanced
                Data Structure and File I/O capabilities for seamless
                organization.
              </div>
      ...
      <div className="vertical-line-at-scroll-down-at-LibManSys">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
          ...
          className="scroll-icon-svg-at-LibManSys"
        >
